    ...
    <>
        ...
        <div className="wrap hero-grid">
          <div>
            ...
            <div className="hero-cta">
              ...
              <Link href="/report" className="btn btn-ghost btn-lg">Start an inspection</Link>
            </div>
      ...
      <section className="section" id="features" style={{ background: '#fff', borderTop: '1px solid var(--line)', borderBottom: '1px solid var(--line)' }}>
        <div className="wrap">
          ...
          <div className="feat reveal">
            <div className="feat-text">
              <div className="num">Tool 02 · Most loved</div>
              <h3>Guided move-in inspection</h3>
              <p>A room by room walk through that is mostly tapping. AI reads your photos, describes the damage, and locks a timestamped report. You and your landlord both get the same record, so everyone stays accountable.</p>
              <ul className="feat-list"><li>One room at a time, finished in five minutes</li><li>AI describes the damage in every photo</li><li>Locked, timestamped, sent to both sides</li></ul>
